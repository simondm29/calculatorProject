...
@Composable
fun CalcLandscape(modifier: Modifier = Modifier){
...
@Composable
fun CalcPortrait(modifier: Modifier = Modifier){
    var text1 by remember { mutableStateOf("0")}
    var text2 by remember { mutableStateOf("0")}
    var text3 by remember { mutableStateOf("0")}
...
@Composable
fun ItemLand(modifier: Modifier = Modifier, itemNumber: Number, text: String, onValueChange: (String) -> Unit) {
    Row(
//        horizontalArrangement = Arrangement.SpaceEvenly,
//        modifier = Modifier.fillMaxWidth(),
        verticalAlignment = Alignment.CenterVertically,
